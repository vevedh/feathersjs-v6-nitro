...
assert.equal(pkg.version, '0.1.0-alpha.10')
...
assert.equal(pkg.scripts?.['validate:patch013:windows'], 'powershell -NoProfile -ExecutionPolicy Bypass -File scripts/validate-patch013.ps1')
